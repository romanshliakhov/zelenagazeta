...
/* harmony import */ var _components_modals_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/modals.js */ "./source/js/components/modals.js");
/* harmony import */ var _components_copy_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/copy.js */ "./source/js/components/copy.js");
/* harmony import */ var _components_copy_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_components_copy_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _components_cookies_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/cookies.js */ "./source/js/components/cookies.js");
...
/* harmony import */ var _components_acc_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/acc.js */ "./source/js/components/acc.js");
...
/* harmony import */ var _components_tabs_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/tabs.js */ "./source/js/components/tabs.js");
/* harmony import */ var _components_select_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/select.js */ "./source/js/components/select.js");
/* harmony import */ var _components_sliders_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/sliders.js */ "./source/js/components/sliders.js");
/* harmony import */ var _components_anchor_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/anchor.js */ "./source/js/components/anchor.js");
/* harmony import */ var _components_fancybox_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/fancybox.js */ "./source/js/components/fancybox.js");
/* harmony import */ var _components_modalStartingPodcasts_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/modalStartingPodcasts.js */ "./source/js/components/modalStartingPodcasts.js");
/* harmony import */ var _components_modalStartingPodcasts_js__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_components_modalStartingPodcasts_js__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _components_videoPlayer_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/videoPlayer.js */ "./source/js/components/videoPlayer.js");
/* harmony import */ var _components_videoPlayer_js__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_components_videoPlayer_js__WEBPACK_IMPORTED_MODULE_12__);
  ...
  accParents.forEach(accordionParent => {
    if (accordionParent) {
      ...
      if (accordionParent.dataset.default) {
        ...
        accordionParent._openedAccordion = accordionParent.querySelector(`[data-content="${accordionParent.dataset.default}"]`);
      }
...
/***/ "./source/js/components/colorTheme.js":
/*!********************************************!*\
  !*** ./source/js/components/colorTheme.js ***!
  \********************************************/
/***/ (function() {
...
/***/ "./source/js/components/cookies.js":
/*!*****************************************!*\
  !*** ./source/js/components/cookies.js ***!
  \*****************************************/
/***/ (function() {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_functions_customFunctions_js__WEBPACK_IMPORTED_MODULE_1__.elementHeight)(headerTop, 'header-top');
});
...
/***/ "./source/js/components/modalStartingPodcasts.js":
/*!*******************************************************!*\
  !*** ./source/js/components/modalStartingPodcasts.js ***!
  \*******************************************************/
/***/ (function() {
...
class ModalManager {
  ...
  bindEvents() {
    ...
    this.modalsButton.forEach(btn => btn.addEventListener("click", e => this.buttonClickHandler(e, "data-btn-modal")));
    this.innerButtonModal.forEach(btn => btn.addEventListener("click", e => this.innerButtonClickHandler(e)));
  }
  ...
  openModal(attributeValue) {
    ...
    const activeModal = Array.from(this.modals).find(m => m.classList.contains(this.activeClass) && m !== modal);
    if (activeModal) {
      (0,_functions_customFunctions_js__WEBPACK_IMPORTED_MODULE_2__.fadeOut)(activeModal, this.timeOut);
      (0,_functions_customFunctions_js__WEBPACK_IMPORTED_MODULE_2__.removeCustomClass)(activeModal, this.activeClass);
    }
  ...
  innerButtonClickHandler(e) {
    ...
    (0,_functions_customFunctions_js__WEBPACK_IMPORTED_MODULE_2__.fadeOut)(prevModal, this.timeOut);
    (0,_functions_customFunctions_js__WEBPACK_IMPORTED_MODULE_2__.removeCustomClass)(prevModal, this.activeClass);

    // Убедиться, что другие тоже не активны
    this.modals.forEach(modal => {
      if (modal !== currentModal) {
        (0,_functions_customFunctions_js__WEBPACK_IMPORTED_MODULE_2__.removeCustomClass)(modal, this.activeClass);
        modal.style.display = 'none';
      }
    });

    // Показать новую модалку
    (0,_functions_customFunctions_js__WEBPACK_IMPORTED_MODULE_2__.fadeIn)(currentModal, this.timeIn, 'flex');
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (searchBtn && searchWrapper) {
      searchBtn.addEventListener("click", e => {
        ...
        if (searchWrapper.classList.contains("active")) {
          (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.removeCustomClass)(searchWrapper, "active");
          (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.removeCustomClass)(container, "active");
          (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.removeCustomClass)(container, "result");
        } else {
          (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.addCustomClass)(searchWrapper, "active");
          (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.addCustomClass)(container, "active");
        }
      });
    }
    input.addEventListener('change', function (e) {
      (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.addCustomClass)(container, "result");
    });
  });
  document.addEventListener("click", e => {
    search && search.forEach(container => {
      ...
      const searchBtn = container.querySelector(".search-form__btn");
      const input = container.querySelector(".search-form__input");
      if (searchWrapper && !searchWrapper.contains(e.target) && !searchBtn.contains(e.target) && !input.contains(e.target)) {
        (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.removeCustomClass)(searchWrapper, "active");
        (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.removeCustomClass)(container, "active");
        (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_1__.removeCustomClass)(container, "result");
      }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (videosSliders) {
    videosSliders.forEach(function (slider) {
      ...
      const videosSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](container, {
        ...
        simulateTouch: false,
        // если ещё надо полностью убрать "перетаскивание мышкой" по слайдам
  ...
  if (discoverySliders) {
    discoverySliders.forEach(function (slider) {
      ...
      const prevBtn = slider.querySelector(".swiper-button.prev");
      const pagination = slider.querySelector(".swiper-pagination");
      const discoverySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](container, {
        modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Pagination],
        spaceBetween: 20,
        slidesPerView: 1,
        speed: 1400,
      ...
      if (window.innerWidth <= 1024) {
        if (categoriesSwipers.length === 0) {
          categoriesSliders.forEach(function (slider) {
            ...
            const prevBtn = slider.querySelector(".swiper-button.prev");
            const pagination = slider.querySelector(".swiper-pagination");
            const swiperInstance = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](container, {
              modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Pagination],
              spaceBetween: 20,
              slidesPerView: 3,
              speed: 1400,
  ...
  if (moreArticlesSliders) {
    moreArticlesSliders.forEach(function (slider) {
      ...
      const prevBtn = slider.querySelector(".swiper-button.prev");
      const pagination = slider.querySelector(".swiper-pagination");
      const moreArticlesSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](container, {
        modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Pagination],
        spaceBetween: 20,
        slidesPerView: 3,
        speed: 1400,
  ...
  if (tagsSliders) {
    tagsSliders.forEach(function (slider) {
      ...
      const nextBtn = slider.querySelector(".swiper-button.next");
      const prevBtn = slider.querySelector(".swiper-button.prev");
      const tagsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](container, {
  ...
  if (podcastsSliders) {
    podcastsSliders.forEach(function (slider) {
      ...
      const nextBtn = slider.querySelector(".swiper-button.next");
      const prevBtn = slider.querySelector(".swiper-button.prev");
      const podcastsSliderSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](container, {
        modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Pagination],
        spaceBetween: 20,
        slidesPerView: 3,
        speed: 1400,
    ...
    if (tabParent) {
      ...
      if (tabButton) {
        tabButton.addEventListener("click", () => {
          const activeIndex = tabNav.findIndex(nav => nav.classList.contains(active));
          const newIndex = activeIndex === 0 ? 1 : 0;
          const newActiveTabAttr = tabNav[newIndex].getAttribute(tabsNavAttr);
          (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_0__.removeClassInArray)(tabNav, active);
          (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_0__.removeClassInArray)(tabContent, active);
          (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_0__.addCustomClass)(tabNav[newIndex], active);
          (0,_functions_customFunctions__WEBPACK_IMPORTED_MODULE_0__.addCustomClass)(tabParent.querySelector(`[${tabsContentAttr}="${newActiveTabAttr}"]`), active);
        });
      }
    }
  });
...
/***/ "./source/js/components/videoPlayer.js":
/*!*********************************************!*\
  !*** ./source/js/components/videoPlayer.js ***!
  \*********************************************/
/***/ (function() {
...
/******/ 	__webpack_require__("./source/js/components/cookies.js");
/******/ 	__webpack_require__("./source/js/components/copy.js");
...
/******/ 	__webpack_require__("./source/js/components/modalStartingPodcasts.js");
